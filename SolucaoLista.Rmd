...
knn_k1 = knn(train = dados_treino[, 1:2], test = dados_teste[, 1:2], cl = dados_treino$y, k = 1)
knn_k10 = knn(train = dados_treino[, 1:2], test = dados_teste[, 1:2], cl = dados_treino$y, k = 10)
